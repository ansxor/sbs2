...
const announce_counts = Object.create(null);
export function UserList({ id, status, className = 'userlist', style }) {
        ...
        return () => {
            ...
            if (status !== undefined) {
                ...
                if (announce_counts[id] <= 0) {
                    ...
                    display.set_status(null);
                }
            }
        };
    }, [id, status]);
    return _jsx("div", { ref: ref, className: className, style: style });
}
