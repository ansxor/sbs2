...
export function App() {
    ...
    return (_jsxs("div", { className: "resize-box ROW", style: { position: 'fixed', inset: 0 }, children: [_jsxs("not-sidebar", { className: "FILL ROW", id: "$main_slides", children: [_jsx("button", { id: "$openSidebar", className: "toggle-sidebar", onClick: () => toggleSidebar(), children: "| | |" }), _jsx(Slots, {})] }), _jsx("resize-handle", { id: "$horizontalResize", className: "sidebar-element", ref: handleRef }), _jsx(Sidebar, { containerRef: containerRef })] }));
}
